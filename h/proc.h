...
struct	pentry	{
	...
	int	pwaitret;
	int remainingquantum; 		/* Remaining quantum before rescheduling */
	int quantum; 				/* Current time quantum for this process */
	int goodness; 				/* Goodness value used for process selection */
